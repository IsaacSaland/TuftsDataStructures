...
int main(int argc, char **argv) {
    ...
    { "testDSConstructor", testDSConstructor },
    { "testDSEmptyClear", testDSEmptyClear },
    { "testDSTop", testDSTop },
    { "testDSTopFail", testDSTopFail },
    { "testDSPop", testDSPop },
    { "testDSPopFail", testDSPopFail },
    { "testDSPush", testDSPush },
    { "testParseRString", testParseRString },
    { "testRPNEmptyClear", testRPNEmptyClear },
    { "testRPNPeekPop", testRPNPeekPop },
    { "testRPNConstructors", testRPNConstructors },
